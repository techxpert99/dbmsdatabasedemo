...
$user_image = get('user')['profilepic'];
...
<head>
    ...
    <title>User Profile: <?php echo get('user')['first_name'].' '.get('user')['last_name'];?></title>
    ...
    <div class="body-wrap boxed-container">
        <header class="site-header">
            <div class="container">
                ...
                <div class="site-header-inner" style="position:relative;float:right;">
                    <button class="xbutton xbutton2" onclick="window.location='index.php?service=logout';"> Logout </button>
                </div>
                <br/><br/>
                <div class="container">
                    <div style="float:left;margin:20px">
                        <?php
                            $img = imagecreatefromstring(base64_decode($user_image));
                            $x = imagesx($img);
                            $y = imagesy($img);
                            /* Landscape */
                            if($x > $y){
                                    echo "<div style=\"display:inline-block;position:relative;width:150px;height:150px;overflow:hidden;border-radius:50%;border: 5px solid #ddd\">
                                            <img src=\"data:image/jpg;base64,$user_image\"alt=\"$user_name\" style=\" width: auto;height: 100%;\"/></div>";
                            }
                            /* Portrait */
                            else{
                                echo "<div style=\"position: relative;width: 150px;height: 150px;overflow: hidden;border-radius: 50%;border: 5px solid #ddd;\">
                                <img src=\"data:image/jpg;base64,$user_image\" alt=\"$user_name\" style=\"width: 100%;height: auto;\"/></div>";
                            }
                        ?>
                    </div>
                    <div class="mt-3" style="float:left;margin:20px;position:relative;z-index:1;">
                        <h4><?php echo get('user')['first_name'].' '.get('user')['last_name'];?></h4>
                        <p class="text-secondary mb-1" style="margin-bottom:5px;"><?php echo get('user')['username'];?></p>
                        <p class="text-muted font-size-sm"><?php echo get('user')['city'].', '.get('user')['state'].', '.get('user')['country'];?></p>
                        <button class="xbutton xbutton2"> Follow</button>
                        <button class="xbutton xbutton2"> Message</button>
                    </div>
                    <div class="hero-illustration" style="float:right;margin:20px;z-index:0;">
							<div class="hero-bg">
                    ...
                    <div>
                        <div style="margin:20px;position:relative;z-index:1;">
                            ...
                            <div class="col-sm-9 text-secondary" style="position:relative;z-index:1;">
                                <?php echo get('user')['first_name'].' '.get('user')['last_name'];?>
                            </div>
                            <hr>
                        </div>
                        <div style="margin:20px;position:relative;z-index:1;">
                            ...
                            <div class="col-sm-9 text-secondary" style="position:relative;z-index:1;">
                                <?php echo get('user')['flat_no'].', '.get('user')['street'].', '.get('user')['city'].', '.get('user')['state'].', '.get('user')['country'];?>
                            </div>
                            <hr>
                        </div>
                        <div style="margin:20px;position:relative;z-index:1;">
                        ...
                        <div style="margin:20px;z-index:1;">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <?php
                                    if(strtolower(get('user')['sex']) == 'male') echo 'Male';
                                    else if(strtolower(get('user')['sex']) == 'female') echo 'Female';
                                    else echo 'Other';
                                ?>
                            </div>
                            <hr>
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h3 class="hero-title mt-0 is-revealing">Search for People</h3>
							<div class="hero-form field field-grouped is-revealing">
	                            <div class="control control-expanded">
	                                <input class="input" type="search" id="search" name="search" placeholder="Enter something to search!">
	                            </div>
	                            <div class="control">
	                                <a class="button button-primary button-block" href="#">Search</a>
	                            </div>
	                        </div>
						</div>  
                    </div>
	                        ...
	                        <div class="feature">
	                            <div class="feature-inner">
									<div class="feature-header mb-16">
		                                ...
		                                <h4 class="feature-title m-0"> Posts </h4>
									</div>
	                                <p class="text-sm mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec id nibh orci. In quam lectus, mattis non magna vel, faucibus tristique diam. Quisque eu lobortis augue, et congue libero. Donec vitae lectus vitae lorem fringilla tristique. Sed lectus orci, malesuada eleifend facilisis vel, semper auctor metus. Cras ultrices tristique euismod. Quisque fermentum nulla nec mauris convallis interdum. Suspendisse potenti. Aenean aliquet est at leo pulvinar, et luctus felis feugiat. Donec egestas egestas sapien non imperdiet. Proin sed turpis id dui porttitor luctus et et ipsum. Sed sit amet dolor ultricies, rhoncus est fermentum, elementum felis.</p>
	                            </div>
	                        </div>
						</div>
                    </div>
